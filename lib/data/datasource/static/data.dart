...
class Data {
  static List<Post> dataList = [
    Post(
      ...
      postImage: '',
      isCreate: true,
      postText: 'Hello there, this is a post without an image.',
    ),
    Post(
      ...
      isCreate: false,
      postText: "✨“Push it to the limit, push it through the pain.”",
    ),
    Post(
      userName: 'Abbie Stoe',
      hour: '8hr ago',
    ...
    Post(
      ...
      postImage: '',
      isCreate: false,
      postText: 'Hello there, this is a post with an image.',
    ),
    Post(
      ...
      isCreate: false,
      postText:
          "There's a saying in business, \"Who Moved My Cheese?,\" based off of a popular book.  I own a business, where I've spent roughly 40k in consulting fees over six to have the #1 spot in the google engines for my business.  I've ignored bing, because no one is on it, and they were using yelp as a review source (yelp has been horrible for me).  If this change starts to go through in March, I can definitely see bing get at least 1/3 browser market share in short order.  So the place in the maze where I got my cheese has moved.  And I have to now comply with Bing's set of rules, or I'm going to lose 1/3 of my customers.  Joy.  Business owners need to get ahead of this, and not get caught flabbergasted.  SIDE NOTE:  does anyone know how to change review source in bing to Angi's List?",
    ),
  ];
}
